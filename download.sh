...
python3 main.py --url https://www.ipc-services.org/sdms/web/ranking/at/excel/type/WR/list/1155/category/out --output leads/world.csv --code WL
python3 main.py --url https://www.ipc-services.org/sdms/web/ranking/at/excel/type/AFR/list/1155/category/out --output leads/africa.csv --code AL
python3 main.py --url https://www.ipc-services.org/sdms/web/ranking/at/excel/type/AMR/list/1155/category/out --output leads/america.csv --code AL
python3 main.py --url https://www.ipc-services.org/sdms/web/ranking/at/excel/type/ASR/list/1155/category/out --output leads/asia.csv --code AL
python3 main.py --url https://www.ipc-services.org/sdms/web/ranking/at/excel/type/EUR/list/1155/category/out --output leads/europe.csv --code AL
python3 main.py --url https://www.ipc-services.org/sdms/web/ranking/at/excel/type/OCR/list/1155/category/out --output leads/oceania.csv --code AL
